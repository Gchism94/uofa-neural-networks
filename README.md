...
| [`multi_layer_perceptron/mlp_explorer.html`](multi_layer_perceptron/mlp_explorer.html) | Interactive MLP explorer: XOR, hidden-layer representations, backpropagation as gradient flow, and depth vs. width as a complexity story |
| [`unsupervised_learning/autoencoder_explorer.html`](unsupervised_learning/autoencoder_explorer.html) | Interactive autoencoder explorer: train a deep autoencoder on MNIST-like digit data and watch the 2-D bottleneck encoding cluster by class — unsupervised representation learning with neural networks |
...
| [`spiking_neural_networks/snn_explorer.html`](spiking_neural_networks/snn_explorer.html) | Interactive explorer for spiking neural networks: simulate leaky integrate-and-fire neurons, visualize spike trains and membrane potentials, and explore STDP — the biologically plausible Hebbian learning rule linking neural firing timing to synaptic weight updates |
